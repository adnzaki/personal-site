<style id="kevinbatdorf-code-block-pro-style-inline-css">
    ...
    .wp-block-kevinbatdorf-code-block-pro.cbp-highlight-hover:not(.cbp-blur-enabled:not(.cbp-unblur-on-hover)) .line:hover .cbp-line-highlighter {
        background: var(--cbp-line-highlight-color, rgba(14, 165, 233, .2)) !important;
        left: -16px !important;
        min-height: var(--cbp-block-height, 100%) !important;
    ...
    /*# sourceURL=https://cms.bitdanbait.web.id/wp-content/plugins/code-block-pro/build/style-index.css */
</style>